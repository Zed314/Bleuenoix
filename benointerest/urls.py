 ...
 #                   context_object_name="memes",
  #                  template_name="benointerest/accueil.html")),
    # path('senddamemes', views.sendmemes, name  = "sendmemes"),
     ...
     path('updatememe/<int:pk>', login_required(views.UpdateMeme.as_view()), name  = "updatememe"),
  #   path(r'^meme/(?P<pk>\d+)$', views.SeeMeme.as_view(), name = "seememe"),
     path("meme/<int:pk>", login_required(views.SeeMeme.as_view()), name = "seememe"),
     path("connexion",auth_views.login,  {'template_name': 'benointerest/connexion.html'},name='connexion'),
    ...
    # path('activate/<str:uidb64>/<str:token>', views.activate, name='activate'),
     path("profil/<int:pk>", login_required(views.UpdateProfil.as_view()), name  = "updateprofile"),
